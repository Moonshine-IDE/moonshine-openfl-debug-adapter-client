...
/**
	Implementation of `VariablesResponse` body from Debug Adapter Protocol
	...
	**DO NOT** add new properties or methods to this class that are specific to
	...
	@see https://microsoft.github.io/debug-adapter-protocol/specification#Request_Variables
**/
