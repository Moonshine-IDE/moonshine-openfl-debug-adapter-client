...
/**
	...
	**DO NOT** add new properties or methods to this class that are specific to
	...
	@see https://microsoft.github.io/debug-adapter-protocol/specification#capabilities
**/
typedef Capabilities = {
	...
	// ?exceptionBreakpointFilters:Bool,
	...
	// ?additionalModuleColumns:Bool,
	// ?supportedChecksumAlgorithms:Bool,
