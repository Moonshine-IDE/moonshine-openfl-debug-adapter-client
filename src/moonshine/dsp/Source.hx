...
/**
	Implementation of `Source` interface from Debug Server Protocol
	...
	**DO NOT** add new properties or methods to this class that are specific to
	...
	@see https://microsoft.github.io/debug-adapter-protocol/specification#Types_Source
**/
typedef Source = {
	name:String,
	path:String,
	sourceReference:Float,
}
